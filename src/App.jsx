    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
              With Preline, we are able to easily track our performance in full detail. Its become an essential tool for us to grow and engage with our audience. 
            </p>
          </div>
      ...
      <div className="flex h-auto">
        <div className="flex flex-col bg-white rounded-xl dark:bg-slate-900">
          <div className="flex-auto p-4 md:p-6">
            <p className="text-base italic md:text-lg text-gray-800 dark:text-gray-200">
              In September, I will be using this theme for 2 years. I went through multiple updates and changes and Im very glad to see the consistency and effort made by the team. 
            </p>
          </div>
  ...
  <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
    ...
    <div>
      ...
      <div className="mt-3 grid space-y-3 text-sm">
        ...
        <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Careers</a> <span className="inline text-blue-600 dark:text-blue-500">— We are hiring</span></p>
    ...
    <div>
      ...
      <div className="mt-3 grid space-y-3 text-sm">
        ...
        <p><a className="inline-flex gap-x-2 text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200" href="#">Whats New</a></p>
